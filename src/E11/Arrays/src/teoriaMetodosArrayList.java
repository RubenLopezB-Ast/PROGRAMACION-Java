...
public class teoriaMetodosArrayList {
    public static void main(String[] args) {

        Scanner entrada = new Scanner(System.in);
        ArrayList<String> nombres = new ArrayList<>(); // Instanciar(crar) un ArrayList sin meter datos(ni longitud, ni valores)
        ...
        do {
            ...
            System.out.println("3. Reemplazar nombres (Set): ");
            System.out.println("4. Eliminar nombre por posición (remove)");
            System.out.println("5. Verificar si un nombre existe (contains)");
            System.out.println("6. Obtenere indice de un nombre (indexOf)");
            ...
            entrada.nextLine(); // Se hace para limpiar el buff y que  no se trabe
            ...
            switch (opcion){
                ...
                case 7->{
                    nombres.clear();
                    System.out.println("Lista eliminada completamente");
                }
                case 8 ->{
