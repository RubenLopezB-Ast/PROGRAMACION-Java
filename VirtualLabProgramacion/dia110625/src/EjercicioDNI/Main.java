...
public class Main {
    public static void main(String[] args) {
        ...
        Crea una clase NIF que represente el DNI con su correspondiente letra. Los atributos de la clase serán el
         número de DNI y su letra.
        ...
        Un método leer(): que pida por teclado el número de DNI y calcule a partir del DNI introducido la letra que
         le corresponde.
        Método toString() que m
        que muestre el NIF de la siguiente forma: ocho dígitos, un guión y la letra en mayúscula. Por ejemplo: 12345678-Z
